...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions_littleFS.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions_littleFS.csv"
...
#define CONFIG_LWIP_SNTP_UPDATE_DELAY 50000
